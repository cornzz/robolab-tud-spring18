...
def run():
    ...
    mc = MotorController.MotorController(0.5, 0.2, 0.05, 5, color_setpoint)
    ...
    while not ts1.value() and not ts2.value():
        ...
        print('color: ', color_values[0], color_values[1], color_values[2], (color_values[0] + color_values[1] + color_values[2]) / 3)
