...
class TestPlanet(unittest.TestCase):
    ...
    def test_shortest_path(self):
        self.planet = create_planet()
        start = self.planet.vertexes[(0, 0)]
        target = self.planet.vertexes[(-2, 1)]
...
def create_planet():
    ...
    planet.add_path(planet.vertexes[(0, 2)], Direction.WEST)
    ...
    planet.add_edge(
        planet.paths[((0, 2), Direction.WEST)], planet.paths[((-1, 2), Direction.EAST)], 10)
    planet.add_edge(
    ...
    planet.add_edge(
        planet.paths[((-2, 1), Direction.EAST)], planet.paths[((0, 0), Direction.WEST)], 1)
    return planet
